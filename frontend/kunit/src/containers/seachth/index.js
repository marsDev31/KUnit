      ...
      <div>
        ...
        <h3 style={{ paddingTop: 14 }}>
          <div className="form-inline">
            ...
            <ResponTopic>
              3. เพิ่มวิชาที่เคยเรียน หรือ วิชาที่ต้องการลงทะเบียน{' '}
            </ResponTopic>
            {/* </div> */}
            ...
            <button
              ...
              data-place="top"
              data-multiline={true}
              data-tip="เพิ่มวิชาที่เคยลงทะเบียนหรือวิชาที่ต้องการลงทะเบียน โดยวิชาที่ถูกเพิ่มจะแสดงในตารางถัดไป <br/>(ค้นหาและเพิ่มได้เรื่อยๆ และสามารถพิมพ์ค้นหาวิชาด้วยส่วนหนึ่งของ ชื่อวิชา รหัสวิชา )"
              style={{
                fontSize: '12px',
                marginLeft: '6px',
                paddingTop: '0px',
